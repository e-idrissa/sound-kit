...
export function InstrumentsTable<TData, TValue>({
  columns,
  data,
  isAdmin
  ...
  return (
    <div className="bg-background w-full p-8 border-input border rounded-lg space-y-4">
      <div className="flex flex-col gap-4 lg:gap-0 lg:flex-row lg:items-center lg:justify-between w-full">
        <div className="flex items-center gap-4">
          {isAdmin && (<InstrumentDialog />)}
          {!isAdmin && (
            <Button size={"sm"} variant={"outline"}>
              <span>Request Intrument</span>
            </Button>
          )}
        </div>
